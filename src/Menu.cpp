...
void Menu::draw(){
    ...
    rectangleStart.setPosition(window.getSize().x/2 - rectangleStart.getSize().x/2, window.getSize().y/2 - rectangleStart.getSize().y/2);
    ...
    textTitle.setPosition(window.getSize().x/2 - textTitle.getGlobalBounds().width/2, window.getSize().y/2 - textTitle.getGlobalBounds().height/2 - rectangleStart.getSize().y - 100);
